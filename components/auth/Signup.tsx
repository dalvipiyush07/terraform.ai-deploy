      ...
      <div className="w-full max-w-md">
        <div className="bg-[#1c2333] border border-[#21262d] rounded-lg p-8 shadow-2xl">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-[#f0f6fc] mb-2">Create account</h1>
            <p className="text-[#8b949e] text-sm">Start building with CloudArchitect</p>
          </div>

          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-xs font-medium text-[#8b949e] mb-2">Name</label>
              <input
                type="text"
                value={name}
